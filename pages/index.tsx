  ...
  return (
    <>
      ...
      <div data-theme="winter">
        <div
          className="hero max-h-screen h-[50vh] bg-base-200"
          style={{
          ...
          <div className="hero-content text-center">
            <div className="max-w-md">
              <h1 className="text-5xl font-bold text-base-100">
                Create your own <i>beautiful</i> brand
              </h1>
  ...
  return (
    <footer className="footer p-10 bg-neutral text-neutral-content">
      <div>
        ...
        <p className="text-2xl font-bold">Orchid</p>
      </div>
      <div>
    ...
    <div className="card bg-base-300">
      <figure className="p-2 pb-0">
        <Image
          ...
          height={300}
          alt="Placeholder"
          className="rounded-xl aspect-square bg-black"
        />
      </figure>
      <div className="card-body">
        <h2 className="card-title justify-center">{name}</h2>
        <p className="text-base-content capitalize">{role}</p>
      </div>
    </div>
  );
}
